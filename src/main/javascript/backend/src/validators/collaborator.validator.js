...
export const updateProfileSchema = z.object({
  ...
  currentUniversityYear: z.number().int().min(1).max(12).optional().nullable(),
...
export const adminCollaboratorSchema = z.object({
  ...
  currentUniversityYear: z.number().int().min(1).max(12),
  expectedGraduationYear: z.number().int().min(2000),
  experienceDescription: z.string().optional().nullable(),
  motivationDescription: z.string().optional().nullable(),
